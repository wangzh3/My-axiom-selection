%------------------------------------------------------------------------------
% File     : MPT1276+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tops_1__t95_tops_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   35 (   4 unit)
%            Number of atoms       :  119 (  11 equality)
%            Maximal formula depth :   13 (   5 average)
%            Number of connectives :   86 (   2   ~;   1   |;  26   &)
%                                         (   5 <=>;  52  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
...
fof(dt_o_2_2_tops_1,axiom,(
    ! [A,B] :
      ( ( v2_pre_topc(A)
        & l1_pre_topc(A)
        & m1_subset_1(B,k1_zfmisc_1(u1_struct_0(A))) )
     => m1_subset_1(o_2_2_tops_1(A,B),k1_tops_1(A,k2_tops_1(A,B))) ) )).
