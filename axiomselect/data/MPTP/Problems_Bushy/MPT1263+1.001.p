%------------------------------------------------------------------------------
% File     : MPT1263+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tops_1__t80_tops_1---1.p [MPTPTP]
...
%            Number of connectives :   50 (   6   ~;   1   |;  17   &)
%                                         (   6 <=>;  20  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
...
fof(dt_o_2_1_tops_1,axiom,(
    ! [A,B] :
      ( ( v2_pre_topc(A)
        & l1_pre_topc(A)
        & m1_subset_1(B,k1_zfmisc_1(u1_struct_0(A))) )
     => m1_subset_1(o_2_1_tops_1(A,B),B) ) )).
