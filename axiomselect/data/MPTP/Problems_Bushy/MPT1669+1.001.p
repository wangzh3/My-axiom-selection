%------------------------------------------------------------------------------
% File     : MPT1669+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : waybel_0__t49_waybel_0---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   28 (   4 unit)
%            Number of atoms       :  110 (   5 equality)
%            Maximal formula depth :   12 (   6 average)
%            Number of connectives :   98 (  16   ~;   1   |;  43   &)
%                                         (   9 <=>;  29  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   19 (   0 propositional; 1-3 arity)
%            Number of functors    :    8 (   2 constant; 0-2 arity)
%            Number of variables   :   61 (   0 sgn;  55   !;   6   ?)
