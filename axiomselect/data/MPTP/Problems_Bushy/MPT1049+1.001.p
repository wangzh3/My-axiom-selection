%------------------------------------------------------------------------------
% File     : MPT1049+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t166_funct_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   26 (   4 unit)
%            Number of atoms       :  104 (  12 equality)
%            Maximal formula depth :   14 (   6 average)
%            Number of connectives :   82 (   4   ~;   1   |;  33   &)
%                                         (   8 <=>;  36  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   11 (   0 propositional; 1-4 arity)
%            Number of functors    :   10 (   2 constant; 0-3 arity)
%            Number of variables   :   76 (   0 sgn;  74   !;   2   ?)
...
fof(t166_funct_2,conjecture,(
    ! [A,B,C] :
     ...
     => ! [D] :
          ( ( v1_funct_1(D)
            & m1_subset_1(D,k1_zfmisc_1(k2_zfmisc_1(A,B))) )
         => ( ( r1_tarski(k1_relset_1(A,B,D),k1_relset_1(A,B,C))
