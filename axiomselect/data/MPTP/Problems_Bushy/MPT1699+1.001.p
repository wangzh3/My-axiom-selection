%------------------------------------------------------------------------------
% File     : MPT1699+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t8_tmap_1---1.p [MPTPTP]
...
%            Number of connectives :   71 (  14   ~;   0   |;  36   &)
%                                         (   2 <=>;  19  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    6 (   0 propositional; 1-6 arity)
