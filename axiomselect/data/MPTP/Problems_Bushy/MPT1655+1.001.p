%------------------------------------------------------------------------------
% File     : MPT1655+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : waybel_0__t35_waybel_0---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :    6 (   0 unit)
%            Number of atoms       :   43 (   1 equality)
%            Maximal formula depth :   18 (  10 average)
%            Number of connectives :   41 (   4   ~;   0   |;  14   &)
%                                         (   4 <=>;  19  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
