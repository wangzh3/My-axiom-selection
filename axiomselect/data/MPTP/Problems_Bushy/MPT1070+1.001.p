%------------------------------------------------------------------------------
% File     : MPT1070+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t187_funct_2---1.p [MPTPTP]
...
%            Number of connectives :   60 (   1   ~;   1   |;  33   &)
%                                         (   2 <=>;  23  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    8 (   0 propositional; 1-4 arity)
%            Number of functors    :   11 (   2 constant; 0-6 arity)
     ...
     => ! [D] :
         ...
         => ! [E] :
             ...
             => ! [F] :
                  ( ( v1_funct_1(F)
                    & v1_funct_2(F,B,B)
                    & m1_subset_1(F,k1_zfmisc_1(k2_zfmisc_1(B,B))) )
                 => ( r1_tarski(k2_relset_1(B,C,D),k1_relset_1(C,A,E))
                   => r2_funct_2(B,A,k1_partfun1(B,B,B,A,F,k8_funct_2(B,C,A,D,E)),k8_funct_2(B,C,A,k1_partfun1(B,B,B,C,F,D),E)) ) ) ) ) ) )).
