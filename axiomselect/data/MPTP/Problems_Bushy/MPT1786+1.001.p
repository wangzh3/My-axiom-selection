%------------------------------------------------------------------------------
% File     : MPT1786+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t101_tmap_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   23 (   6 unit)
%            Number of atoms       :   78 (  12 equality)
%            Maximal formula depth :   12 (   5 average)
%            Number of connectives :   60 (   5   ~;   1   |;  25   &)
%                                         (   4 <=>;  25  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
     ...
     => ! [B] :
         ...
         => ! [C] :
             ...
             => ! [D] :
                 ...
                 => ( ( r2_hidden(C,u1_pre_topc(A))
                      & r2_hidden(D,a_2_1_tmap_1(A,B)) )
                   => ( r2_hidden(k4_subset_1(u1_struct_0(A),C,D),k5_tmap_1(A,B))
                      & r2_hidden(k9_subset_1(u1_struct_0(A),C,D),k5_tmap_1(A,B)) ) ) ) ) ) ) )).
