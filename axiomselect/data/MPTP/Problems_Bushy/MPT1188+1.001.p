%------------------------------------------------------------------------------
% File     : MPT1188+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : orders_2__t160_orders_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   16 (   0 unit)
%            Number of atoms       :   64 (   4 equality)
%            Maximal formula depth :   10 (   6 average)
%            Number of connectives :   53 (   5   ~;   2   |;  17   &)
%                                         (   4 <=>;  25  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
