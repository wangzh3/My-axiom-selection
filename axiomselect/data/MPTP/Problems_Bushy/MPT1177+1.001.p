%------------------------------------------------------------------------------
% File     : MPT1177+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : orders_2__t84_orders_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   21 (   3 unit)
%            Number of atoms       :  118 (  17 equality)
%            Maximal formula depth :   13 (   7 average)
%            Number of connectives :  118 (  21   ~;   0   |;  55   &)
%                                         (   6 <=>;  36  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
