%------------------------------------------------------------------------------
% File     : MPT1095+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : finset_1__t30_finset_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   17 (   5 unit)
%            Number of atoms       :   59 (  11 equality)
%            Maximal formula depth :   17 (   6 average)
%            Number of connectives :   58 (  16   ~;   3   |;  20   &)
%                                         (   7 <=>;  12  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    8 (   0 propositional; 1-2 arity)
%            Number of functors    :    5 (   2 constant; 0-2 arity)
%            Number of variables   :   46 (   1 sgn;  45   !;   1   ?)
