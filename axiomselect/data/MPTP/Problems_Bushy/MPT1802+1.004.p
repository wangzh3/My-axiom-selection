%------------------------------------------------------------------------------
% File     : MPT1802+1.004 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t118_tmap_1---4.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   27 (   0 unit)
%            Number of atoms       :  159 (  13 equality)
%            Maximal formula depth :   15 (   7 average)
%            Number of connectives :  159 (  27   ~;   1   |;  76   &)
%                                         (   3 <=>;  52  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   16 (   0 propositional; 1-6 arity)
%            Number of functors    :   13 (   0 constant; 1-4 arity)
