%------------------------------------------------------------------------------
% File     : MPT1837+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t153_tmap_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   13 (   0 unit)
%            Number of atoms       :  140 (   6 equality)
%            Maximal formula depth :   23 (  11 average)
%            Number of connectives :  147 (  20   ~;   0   |;  91   &)
%                                         (   2 <=>;  34  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
