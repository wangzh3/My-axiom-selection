%------------------------------------------------------------------------------
% File     : MPT1327+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tops_2__t48_tops_2---1.p [MPTPTP]
...
%            Number of connectives :   43 (   0   ~;   0   |;  10   &)
%                                         (   5 <=>;  28  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
    ...
    ! [A] :
     ...
     => ! [B] :
         ...
         => ! [C] :
              ( m1_subset_1(C,k1_zfmisc_1(k1_zfmisc_1(u1_struct_0(A))))
             => ( v2_tops_2(C,A)
               => v2_tops_2(k1_tops_2(A,B,C),k1_pre_topc(A,B)) ) ) ) ) )).
