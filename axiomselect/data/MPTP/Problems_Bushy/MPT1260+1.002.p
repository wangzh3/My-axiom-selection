%------------------------------------------------------------------------------
% File     : MPT1260+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tops_1__t76_tops_1---2.p [MPTPTP]
...
%            Number of connectives :   32 (   0   ~;   0   |;   6   &)
%                                         (   3 <=>;  23  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
...
fof(l82_tops_1,axiom,(
    ! [A,B,C] :
      ( ( r1_tarski(A,C)
        & B = k6_subset_1(C,A) )
     => r1_tarski(A,k6_subset_1(C,B)) ) )).
