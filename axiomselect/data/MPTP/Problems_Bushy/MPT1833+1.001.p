%------------------------------------------------------------------------------
% File     : MPT1833+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t149_tmap_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :    8 (   0 unit)
%            Number of atoms       :  128 (   2 equality)
%            Maximal formula depth :   23 (  15 average)
%            Number of connectives :  142 (  22   ~;   1   |;  91   &)
%                                         (   4 <=>;  24  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
