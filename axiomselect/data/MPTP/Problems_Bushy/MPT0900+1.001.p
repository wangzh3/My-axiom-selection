%------------------------------------------------------------------------------
% File     : MPT0900+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : mcart_1__t60_mcart_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   10 (   0 unit)
%            Number of atoms       :   60 (  38 equality)
%            Maximal formula depth :   21 (  15 average)
%            Number of connectives :   86 (  36   ~;   0   |;  25   &)
%                                         (   4 <=>;  21  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 2-2 arity)
%            Number of functors    :    7 (   1 constant; 0-5 arity)
%            Number of variables   :   74 (   0 sgn;  73   !;   1   ?)
