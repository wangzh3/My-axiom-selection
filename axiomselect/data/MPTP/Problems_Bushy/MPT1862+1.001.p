%------------------------------------------------------------------------------
% File     : MPT1862+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tex_2__t30_tex_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   12 (   3 unit)
%            Number of atoms       :   42 (   8 equality)
%            Maximal formula depth :   14 (   6 average)
%            Number of connectives :   32 (   2   ~;   0   |;  10   &)
%                                         (   1 <=>;  19  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
