%------------------------------------------------------------------------------
% File     : MPT1686+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : waybel_0__t66_waybel_0---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   21 (   2 unit)
%            Number of atoms       :  119 (  20 equality)
%            Maximal formula depth :   20 (   8 average)
%            Number of connectives :  112 (  14   ~;   3   |;  47   &)
%                                         (   9 <=>;  39  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   14 (   0 propositional; 1-3 arity)
%            Number of functors    :   11 (   1 constant; 0-4 arity)
%            Number of variables   :   59 (   0 sgn;  56   !;   3   ?)
