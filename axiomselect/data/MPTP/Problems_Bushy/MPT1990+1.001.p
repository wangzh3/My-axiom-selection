%------------------------------------------------------------------------------
% File     : MPT1990+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : waybel_7__t39_waybel_7---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   19 (   0 unit)
%            Number of atoms       :  147 (   5 equality)
%            Maximal formula depth :   16 (   8 average)
%            Number of connectives :  148 (  20   ~;   1   |;  77   &)
%                                         (   8 <=>;  42  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
