%------------------------------------------------------------------------------
% File     : MPT0355+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : subset_1__t34_subset_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   25 (  12 unit)
%            Number of atoms       :   47 (  17 equality)
%            Maximal formula depth :    6 (   4 average)
%            Number of connectives :   25 (   3   ~;   0   |;   5   &)
%                                         (   4 <=>;  13  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
...
fof(redefinition_k5_subset_1,axiom,(
    ! [A,B,C] :
      ( ( m1_subset_1(B,k1_zfmisc_1(A))
        & m1_subset_1(C,k1_zfmisc_1(A)) )
     => k5_subset_1(A,B,C) = k5_xboole_0(B,C) ) )).
...
fof(t34_subset_1,conjecture,(
    ! [A,B] :
     ...
     => ! [C] :
          ( m1_subset_1(C,k1_zfmisc_1(A))
         => k3_subset_1(A,k5_subset_1(A,B,C)) = k4_subset_1(A,k9_subset_1(A,B,C),k9_subset_1(A,k3_subset_1(A,B),k3_subset_1(A,C))) ) ) )).
