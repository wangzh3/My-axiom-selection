%------------------------------------------------------------------------------
% File     : MPT1759+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
fof(fc1_borsuk_1,axiom,(
    ! [A,B,C,D,E] :
     ...
     => ( v1_funct_1(k5_relat_1(D,E))
        & v1_funct_2(k5_relat_1(D,E),u1_struct_0(A),u1_struct_0(C))
        & v5_pre_topc(k5_relat_1(D,E),A,C) ) ) )).
