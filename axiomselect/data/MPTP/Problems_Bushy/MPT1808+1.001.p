%------------------------------------------------------------------------------
% File     : MPT1808+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t124_tmap_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   15 (   0 unit)
%            Number of atoms       :  158 (   9 equality)
%            Maximal formula depth :   20 (  12 average)
%            Number of connectives :  173 (  30   ~;   0   |;  89   &)
%                                         (   3 <=>;  51  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
