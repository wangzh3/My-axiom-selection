%------------------------------------------------------------------------------
% File     : MPT1801+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t117_tmap_1---1.p [MPTPTP]
...
%            Number of connectives :   70 (  11   ~;   0   |;  32   &)
%                                         (   2 <=>;  25  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   11 (   0 propositional; 1-6 arity)
