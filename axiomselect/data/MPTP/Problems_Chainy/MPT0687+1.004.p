%------------------------------------------------------------------------------
% File     : MPT0687+1.004 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_1__t142_funct_1---4.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   20 (  14 unit)
%            Number of atoms       :   32 (  15 equality)
%            Maximal formula depth :   10 (   5 average)
%            Number of connectives :   20 (   8   ~;   0   |;   5   &)
%                                         (   3 <=>;   4  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    5 (   0 propositional; 1-2 arity)
%            Number of functors    :   16 (   2 constant; 0-8 arity)
