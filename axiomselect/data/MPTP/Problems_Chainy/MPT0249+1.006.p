%------------------------------------------------------------------------------
% File     : MPT0249+1.006 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t44_zfmisc_1---6.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   41 (  27 unit)
%            Number of atoms       :   69 (  51 equality)
%            Maximal formula depth :   12 (   5 average)
%            Number of connectives :   41 (  13   ~;   1   |;  10   &)
%                                         (  14 <=>;   3  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    3 (   0 propositional; 2-2 arity)
%            Number of functors    :   15 (   1 constant; 0-9 arity)
%            Number of variables   :  136 (   2 sgn; 135   !;   1   ?)
