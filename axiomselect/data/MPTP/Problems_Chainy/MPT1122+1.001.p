%------------------------------------------------------------------------------
% File     : MPT1122+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : pre_topc__t53_pre_topc---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   28 (   8 unit)
%            Number of atoms       :   75 (  20 equality)
%            Maximal formula depth :   13 (   5 average)
%            Number of connectives :   51 (   4   ~;   0   |;   9   &)
%                                         (   4 <=>;  34  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
