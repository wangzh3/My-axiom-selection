%------------------------------------------------------------------------------
% File     : MPT0983+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t29_funct_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   26 (   8 unit)
%            Number of atoms       :   87 (  18 equality)
%            Maximal formula depth :   12 (   5 average)
%            Number of connectives :   62 (   1   ~;   2   |;  30   &)
%                                         (   5 <=>;  24  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
