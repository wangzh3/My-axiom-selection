%------------------------------------------------------------------------------
% File     : MPT0270+1.004 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t67_zfmisc_1---4.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   27 (  23 unit)
%            Number of atoms       :   32 (  26 equality)
...
%            Number of variables   :   82 (   2 sgn;  82   !;   0   ?)
