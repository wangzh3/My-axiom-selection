%------------------------------------------------------------------------------
% File     : MPT0212+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t1_zfmisc_1---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   46 (  28 unit)
%            Number of atoms       :   84 (  46 equality)
%            Maximal formula depth :   24 (   5 average)
%            Number of connectives :   66 (  28   ~;   0   |;  21   &)
%                                         (  13 <=>;   4  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    6 (   0 propositional; 1-2 arity)
%            Number of functors    :   15 (   1 constant; 0-9 arity)
%            Number of variables   :  128 (   1 sgn; 127   !;   1   ?)
