%------------------------------------------------------------------------------
% File     : MPT0240+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t35_zfmisc_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :  120 (  40 unit)
%            Number of atoms       :  266 ( 103 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :  209 (  63   ~;   4   |;  69   &)
%                                         (  28 <=>;  45  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    5 (   0 propositional; 1-2 arity)
%            Number of functors    :    8 (   1 constant; 0-2 arity)
%            Number of variables   :  286 (   1 sgn; 280   !;   6   ?)
