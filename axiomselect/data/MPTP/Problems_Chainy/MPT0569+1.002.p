%------------------------------------------------------------------------------
% File     : MPT0569+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : relat_1__t173_relat_1---2.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   22 (   8 unit)
%            Number of atoms       :   52 (  13 equality)
%            Maximal formula depth :    9 (   5 average)
%            Number of connectives :   43 (  13   ~;   0   |;  15   &)
%                                         (   6 <=>;   9  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
