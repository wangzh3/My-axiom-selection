%------------------------------------------------------------------------------
% File     : MPT0393+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : setfam_1__t11_setfam_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :  137 (  65 unit)
%            Number of atoms       :  274 ( 106 equality)
%            Maximal formula depth :   11 (   4 average)
%            Number of connectives :  191 (  54   ~;   6   |;  52   &)
%                                         (  33 <=>;  46  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    5 (   0 propositional; 2-2 arity)
%            Number of functors    :    9 (   1 constant; 0-2 arity)
%            Number of variables   :  321 (   2 sgn; 314   !;   7   ?)
