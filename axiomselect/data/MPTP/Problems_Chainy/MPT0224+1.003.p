%------------------------------------------------------------------------------
% File     : MPT0224+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t19_zfmisc_1---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   23 (  19 unit)
%            Number of atoms       :   40 (  36 equality)
%            Maximal formula depth :   24 (   6 average)
%            Number of connectives :   31 (  14   ~;   0   |;  10   &)
%                                         (   6 <=>;   1  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 2-2 arity)
%            Number of functors    :   14 (   1 constant; 0-9 arity)
%            Number of variables   :   92 (   1 sgn;  92   !;   0   ?)
