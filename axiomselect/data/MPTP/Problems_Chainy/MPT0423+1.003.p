%------------------------------------------------------------------------------
% File     : MPT0423+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : setfam_1__t55_setfam_1---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   29 (  17 unit)
%            Number of atoms       :   60 (  33 equality)
%            Maximal formula depth :   22 (   5 average)
%            Number of connectives :   45 (  14   ~;   1   |;   9   &)
%                                         (   8 <=>;  13  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
