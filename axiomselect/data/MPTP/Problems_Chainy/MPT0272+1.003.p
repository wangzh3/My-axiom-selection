%------------------------------------------------------------------------------
% File     : MPT0272+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t69_zfmisc_1---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   22 (  17 unit)
%            Number of atoms       :   27 (  21 equality)
