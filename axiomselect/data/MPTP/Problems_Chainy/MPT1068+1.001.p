%------------------------------------------------------------------------------
% File     : MPT1068+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t185_funct_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   27 (   2 unit)
%            Number of atoms       :   92 (  16 equality)
%            Maximal formula depth :   13 (   6 average)
%            Number of connectives :   72 (   7   ~;   3   |;  23   &)
%                                         (   3 <=>;  36  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   10 (   0 propositional; 1-3 arity)
%            Number of functors    :   15 (   1 constant; 0-6 arity)
%            Number of variables   :   72 (   0 sgn;  72   !;   0   ?)
