%------------------------------------------------------------------------------
% File     : MPT0103+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : xboole_1__t96_xboole_1---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   31 (  24 unit)
%            Number of atoms       :   41 (  21 equality)
%            Maximal formula depth :    8 (   3 average)
%            Number of connectives :   17 (   7   ~;   0   |;   5   &)
%                                         (   3 <=>;   2  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    5 (   0 propositional; 1-2 arity)
%            Number of functors    :    5 (   1 constant; 0-2 arity)
%            Number of variables   :   64 (   1 sgn;  63   !;   1   ?)
