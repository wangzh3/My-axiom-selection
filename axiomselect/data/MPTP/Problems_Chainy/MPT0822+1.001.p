%------------------------------------------------------------------------------
% File     : MPT0822+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : relset_1__t23_relset_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   66 (  12 unit)
%            Number of atoms       :  170 (  34 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :  139 (  35   ~;   2   |;  36   &)
%                                         (  25 <=>;  41  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   10 (   0 propositional; 1-2 arity)
%            Number of functors    :   16 (   1 constant; 0-3 arity)
%            Number of variables   :  163 (   0 sgn; 158   !;   5   ?)
