%------------------------------------------------------------------------------
% File     : MPT0211+1.005 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : enumset1__t137_enumset1---5.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   24 (  24 unit)
...
%            Number of variables   :  101 (   0 sgn; 101   !;   0   ?)
