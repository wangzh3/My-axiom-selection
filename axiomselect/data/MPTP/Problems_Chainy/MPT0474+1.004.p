%------------------------------------------------------------------------------
% File     : MPT0474+1.004 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : relat_1__t66_relat_1---4.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   21 (  16 unit)
%            Number of atoms       :   31 (  22 equality)
%            Maximal formula depth :    9 (   4 average)
%            Number of connectives :   13 (   3   ~;   0   |;   3   &)
%                                         (   5 <=>;   2  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    3 (   0 propositional; 1-2 arity)
%            Number of functors    :   20 (   2 constant; 0-7 arity)
