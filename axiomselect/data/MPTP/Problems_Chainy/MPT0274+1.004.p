%------------------------------------------------------------------------------
% File     : MPT0274+1.004 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t72_zfmisc_1---4.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   24 (  19 unit)
%            Number of atoms       :   31 (  20 equality)
...
%            Number of variables   :   66 (   2 sgn;  66   !;   0   ?)
