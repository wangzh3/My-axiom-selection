%------------------------------------------------------------------------------
% File     : MPT1012+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t67_funct_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   22 (  13 unit)
%            Number of atoms       :   46 (  21 equality)
%            Maximal formula depth :    9 (   6 average)
%            Number of connectives :   32 (   8   ~;   1   |;  10   &)
%                                         (   4 <=>;   9  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   11 (   0 propositional; 1-3 arity)
%            Number of functors    :   17 (   1 constant; 0-8 arity)
%            Number of variables   :   75 (   1 sgn;  74   !;   1   ?)
