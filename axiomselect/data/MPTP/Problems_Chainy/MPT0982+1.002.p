%------------------------------------------------------------------------------
% File     : MPT0982+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t28_funct_2---2.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   14 (   0 unit)
%            Number of atoms       :   61 (  16 equality)
%            Maximal formula depth :   11 (   7 average)
%            Number of connectives :   47 (   0   ~;   2   |;  18   &)
%                                         (   4 <=>;  23  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    9 (   0 propositional; 1-3 arity)
%            Number of functors    :   10 (   1 constant; 0-6 arity)
