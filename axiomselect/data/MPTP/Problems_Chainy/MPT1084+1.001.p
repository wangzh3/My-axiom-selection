%------------------------------------------------------------------------------
% File     : MPT1084+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t201_funct_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :  138 (  15 unit)
%            Number of atoms       :  701 ( 116 equality)
%            Maximal formula depth :   17 (   7 average)
%            Number of connectives :  647 (  84   ~;   8   |; 272   &)
%                                         (  45 <=>; 238  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   15 (   0 propositional; 1-4 arity)
%            Number of functors    :   24 (   1 constant; 0-6 arity)
%            Number of variables   :  422 (   0 sgn; 404   !;  18   ?)
