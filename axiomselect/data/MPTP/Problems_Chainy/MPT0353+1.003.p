%------------------------------------------------------------------------------
% File     : MPT0353+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : subset_1__t32_subset_1---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   49 (  31 unit)
%            Number of atoms       :   76 (  45 equality)
%            Maximal formula depth :    9 (   4 average)
%            Number of connectives :   31 (   4   ~;   1   |;   4   &)
%                                         (   7 <=>;  15  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    4 (   0 propositional; 2-2 arity)
%            Number of functors    :   12 (   1 constant; 0-3 arity)
%            Number of variables   :  114 (   1 sgn; 114   !;   0   ?)
