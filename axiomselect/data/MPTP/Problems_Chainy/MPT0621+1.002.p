%------------------------------------------------------------------------------
% File     : MPT0621+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_1__t16_funct_1---2.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   38 (  18 unit)
%            Number of atoms       :   92 (  38 equality)
%            Maximal formula depth :   22 (   5 average)
%            Number of connectives :   78 (  24   ~;   0   |;  28   &)
%                                         (   8 <=>;  18  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    8 (   0 propositional; 1-2 arity)
%            Number of functors    :   21 (   2 constant; 0-8 arity)
