%------------------------------------------------------------------------------
% File     : MPT0268+1.005 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t65_zfmisc_1---5.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   27 (  20 unit)
...
%            Number of variables   :   73 (   2 sgn;  73   !;   0   ?)
