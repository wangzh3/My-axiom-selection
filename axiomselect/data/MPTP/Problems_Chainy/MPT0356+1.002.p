%------------------------------------------------------------------------------
% File     : MPT0356+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : subset_1__t35_subset_1---2.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   29 (   5 unit)
%            Number of atoms       :   65 (  13 equality)
%            Maximal formula depth :    7 (   5 average)
%            Number of connectives :   38 (   2   ~;   0   |;   9   &)
%                                         (   4 <=>;  23  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
...
% Comments : 
%------------------------------------------------------------------------------
fof(commutativity_k8_subset_1,axiom,(
    ! [A,B,C] :
      ( m1_subset_1(B,k1_zfmisc_1(A))
     => k8_subset_1(A,B,C) = k8_subset_1(A,C,B) ) )).
