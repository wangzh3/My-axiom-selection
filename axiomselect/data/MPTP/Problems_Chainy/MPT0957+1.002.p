%------------------------------------------------------------------------------
% File     : MPT0957+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : wellord2__t30_wellord2---2.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :  113 (  21 unit)
%            Number of atoms       :  331 (  57 equality)
%            Maximal formula depth :   13 (   6 average)
%            Number of connectives :  272 (  54   ~;   4   |; 100   &)
%                                         (  47 <=>;  67  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   12 (   0 propositional; 1-2 arity)
%            Number of functors    :   21 (   1 constant; 0-2 arity)
%            Number of variables   :  303 (   1 sgn; 281   !;  22   ?)
