%------------------------------------------------------------------------------
% File     : MPT0759+1.004 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : ordinal1__t52_ordinal1---4.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   21 (  18 unit)
...
%            Number of functors    :   16 (   0 constant; 1-8 arity)
