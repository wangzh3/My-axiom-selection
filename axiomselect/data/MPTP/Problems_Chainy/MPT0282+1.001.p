%------------------------------------------------------------------------------
% File     : MPT0282+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t83_zfmisc_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   50 (  26 unit)
%            Number of atoms       :   89 (  40 equality)
%            Maximal formula depth :    8 (   4 average)
%            Number of connectives :   50 (  11   ~;   3   |;  10   &)
%                                         (  13 <=>;  13  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    5 (   0 propositional; 2-2 arity)
%            Number of functors    :    8 (   1 constant; 0-2 arity)
%            Number of variables   :  115 (   2 sgn; 114   !;   1   ?)
