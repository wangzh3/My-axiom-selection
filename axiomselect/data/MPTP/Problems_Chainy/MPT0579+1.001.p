%------------------------------------------------------------------------------
% File     : MPT0579+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : relat_1__t183_relat_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   57 (  29 unit)
%            Number of atoms       :   90 (  42 equality)
%            Maximal formula depth :    6 (   4 average)
%            Number of connectives :   33 (   0   ~;   0   |;   5   &)
%                                         (   2 <=>;  26  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    3 (   0 propositional; 1-2 arity)
%            Number of functors    :   13 (   1 constant; 0-2 arity)
%            Number of variables   :  119 (   0 sgn; 119   !;   0   ?)
