%------------------------------------------------------------------------------
% File     : MPT1772+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t83_tmap_1---2.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :  286 (  24 unit)
%            Number of atoms       : 1339 ( 124 equality)
%            Maximal formula depth :   21 (   7 average)
%            Number of connectives : 1199 ( 146   ~;   4   |; 498   &)
%                                         (  40 <=>; 511  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   28 (   0 propositional; 1-4 arity)
%            Number of functors    :   37 (   1 constant; 0-6 arity)
%            Number of variables   :  750 (   1 sgn; 710   !;  40   ?)
...
fof(s3_subset_1__e4_51__tops_2,axiom,(
    ! [A,B,C,D] :
      ( ( l1_pre_topc(A)
        & m1_pre_topc(B,A)
          ...
          & ! [F] :
             ...
             => ( r2_hidden(F,E)
              <=> ? [G] :
                    ...
                    & G = F
                    & v3_pre_topc(G,A)
                    & r2_hidden(k9_subset_1(u1_struct_0(A),F,D),C) ) ) ) ) ) )).
...
fof(t177_funct_2,axiom,(
    ! [A,B,C] :
     ...
     => ! [D] :
         ...
         => ( ( B = k1_xboole_0
             => A = k1_xboole_0 )
           => k3_subset_1(A,k8_relset_1(A,B,C,D)) = k8_relset_1(A,B,C,k3_subset_1(B,D)) ) ) ) )).
     ...
     => ! [B] :
         ...
         => ! [C] :
             ...
             => ! [D] :
                 ...
                 => ( r1_tmap_1(B,A,C,D)
                  <=> ! [E] :
                        ( m1_connsp_2(E,A,k3_funct_2(u1_struct_0(B),u1_struct_0(A),C,D))
                       => m1_connsp_2(k8_relset_1(u1_struct_0(B),u1_struct_0(A),C,E),B,D) ) ) ) ) ) ) )).
         ...
         => ! [C] :
             ...
             => ! [D] :
                 ...
                 => ? [E] :
                      ...
                      & r2_funct_2(u1_struct_0(C),u1_struct_0(A),k2_tmap_1(B,A,E,C),D) ) ) ) ) ) )).
