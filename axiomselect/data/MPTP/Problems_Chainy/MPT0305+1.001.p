%------------------------------------------------------------------------------
% File     : MPT0305+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t117_zfmisc_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   63 (  30 unit)
%            Number of atoms       :  119 (  53 equality)
%            Maximal formula depth :   10 (   4 average)
%            Number of connectives :   78 (  22   ~;   4   |;  19   &)
%                                         (  17 <=>;  16  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    6 (   0 propositional; 1-2 arity)
%            Number of functors    :   11 (   1 constant; 0-2 arity)
%            Number of variables   :  138 (   2 sgn; 138   !;   0   ?)
