%------------------------------------------------------------------------------
% File     : MPT1726+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t35_tmap_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :    9 (   0 unit)
%            Number of atoms       :   98 (   3 equality)
%            Maximal formula depth :   15 (  11 average)
%            Number of connectives :  134 (  45   ~;   3   |;  55   &)
%                                         (   0 <=>;  31  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    7 (   0 propositional; 1-2 arity)
%            Number of functors    :    2 (   0 constant; 3-3 arity)
         ...
         => ! [C] :
             ...
             => ! [D] :
                  ( ( ~ v2_struct_0(D)
                    & m1_pre_topc(D,A) )
                 => ( ( ~ r1_tsep_1(B,C)
                     => k2_tsep_1(A,B,C) = k2_tsep_1(A,C,B) )
                    & ( ( ( ~ r1_tsep_1(B,C)
                          & ~ r1_tsep_1(k2_tsep_1(A,B,C),D) )
                        | ( ~ r1_tsep_1(C,D)
                          & ~ r1_tsep_1(B,k2_tsep_1(A,C,D)) ) )
                     => k2_tsep_1(A,k2_tsep_1(A,B,C),D) = k2_tsep_1(A,B,k2_tsep_1(A,C,D)) ) ) ) ) ) ) )).
