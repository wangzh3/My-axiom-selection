%------------------------------------------------------------------------------
% File     : MPT0266+1.004 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t63_zfmisc_1---4.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   21 (  17 unit)
...
%            Number of variables   :   74 (   2 sgn;  74   !;   0   ?)
