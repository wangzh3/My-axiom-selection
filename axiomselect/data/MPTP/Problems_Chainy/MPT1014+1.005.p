%------------------------------------------------------------------------------
% File     : MPT1014+1.005 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t75_funct_2---5.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   36 (   6 unit)
%            Number of atoms       :  116 (  30 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :   87 (   7   ~;   2   |;  37   &)
%                                         (   6 <=>;  35  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   15 (   0 propositional; 1-4 arity)
%            Number of functors    :   16 (   1 constant; 0-6 arity)
%            Number of variables   :   74 (   0 sgn;  72   !;   2   ?)
