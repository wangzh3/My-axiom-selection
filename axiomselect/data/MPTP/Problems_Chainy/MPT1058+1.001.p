%------------------------------------------------------------------------------
% File     : MPT1058+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t175_funct_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :  107 (   9 unit)
%            Number of atoms       :  337 (  69 equality)
%            Maximal formula depth :   12 (   5 average)
%            Number of connectives :  258 (  28   ~;   3   |;  83   &)
%                                         (  25 <=>; 119  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   12 (   0 propositional; 1-3 arity)
%            Number of functors    :   16 (   1 constant; 0-2 arity)
%            Number of variables   :  245 (   0 sgn; 233   !;  12   ?)
