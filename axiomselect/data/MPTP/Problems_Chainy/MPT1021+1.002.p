%------------------------------------------------------------------------------
% File     : MPT1021+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t88_funct_2---2.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   45 (   5 unit)
%            Number of atoms       :  145 (  33 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :  116 (  16   ~;   3   |;  47   &)
%                                         (  11 <=>;  39  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   17 (   0 propositional; 1-4 arity)
%            Number of functors    :   17 (   1 constant; 0-6 arity)
%            Number of variables   :   92 (   0 sgn;  92   !;   0   ?)
