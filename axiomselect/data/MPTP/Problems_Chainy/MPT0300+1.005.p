%------------------------------------------------------------------------------
% File     : MPT0300+1.005 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t108_zfmisc_1---5.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   18 (   7 unit)
%            Number of atoms       :   42 (  14 equality)
%            Maximal formula depth :   11 (   6 average)
%            Number of connectives :   38 (  14   ~;   0   |;  15   &)
%                                         (   7 <=>;   2  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    5 (   0 propositional; 1-2 arity)
%            Number of functors    :   11 (   2 constant; 0-8 arity)
%            Number of variables   :   62 (   0 sgn;  59   !;   3   ?)
