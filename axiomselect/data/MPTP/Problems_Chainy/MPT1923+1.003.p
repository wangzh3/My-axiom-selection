%------------------------------------------------------------------------------
% File     : MPT1923+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : yellow_6__t21_yellow_6---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   64 (   0 unit)
%            Number of atoms       :  381 (  26 equality)
%            Maximal formula depth :   18 (   8 average)
%            Number of connectives :  392 (  75   ~;   0   |; 143   &)
%                                         (  13 <=>; 161  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   40 (   0 propositional; 1-3 arity)
%            Number of functors    :   16 (   1 constant; 0-4 arity)
%            Number of variables   :  159 (   0 sgn; 149   !;  10   ?)
