%------------------------------------------------------------------------------
% File     : MPT1338+1.005 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tops_2__t62_tops_2---5.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   51 (  17 unit)
%            Number of atoms       :  150 (  48 equality)
%            Maximal formula depth :    9 (   5 average)
%            Number of connectives :  113 (  14   ~;   1   |;  46   &)
%                                         (   9 <=>;  43  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   16 (   0 propositional; 1-3 arity)
%            Number of functors    :   32 (   2 constant; 0-8 arity)
