%------------------------------------------------------------------------------
% File     : MPT0990+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t36_funct_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   21 (   1 unit)
%            Number of atoms       :  119 (  29 equality)
%            Maximal formula depth :   12 (   7 average)
%            Number of connectives :   99 (   1   ~;   4   |;  56   &)
%                                         (   1 <=>;  37  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    7 (   0 propositional; 1-4 arity)
%            Number of functors    :   14 (   1 constant; 0-6 arity)
