%------------------------------------------------------------------------------
% File     : MPT0264+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t59_zfmisc_1---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   24 (  18 unit)
%            Number of atoms       :   36 (  28 equality)
%            Maximal formula depth :   12 (   5 average)
%            Number of connectives :   18 (   6   ~;   0   |;   5   &)
%                                         (   5 <=>;   2  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    3 (   0 propositional; 2-2 arity)
%            Number of functors    :   13 (   1 constant; 0-8 arity)
%            Number of variables   :   80 (   2 sgn;  80   !;   0   ?)
