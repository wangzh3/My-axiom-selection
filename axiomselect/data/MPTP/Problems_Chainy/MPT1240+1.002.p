%------------------------------------------------------------------------------
% File     : MPT1240+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tops_1__t54_tops_1---2.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   31 (   8 unit)
%            Number of atoms       :   85 (  20 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :   58 (   4   ~;   0   |;  16   &)
%                                         (   6 <=>;  32  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
