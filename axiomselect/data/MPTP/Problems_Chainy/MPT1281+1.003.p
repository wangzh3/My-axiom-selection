%------------------------------------------------------------------------------
% File     : MPT1281+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tops_1__t103_tops_1---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   66 (   2 unit)
%            Number of atoms       :  224 (  26 equality)
%            Maximal formula depth :   14 (   6 average)
%            Number of connectives :  170 (  12   ~;   0   |;  26   &)
%                                         (  22 <=>; 110  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   16 (   0 propositional; 1-2 arity)
%            Number of functors    :   14 (   1 constant; 0-3 arity)
%            Number of variables   :  148 (   0 sgn; 145   !;   3   ?)
...
fof(t64_tops_1,axiom,(
    ! [A] :
      ( l1_pre_topc(A)
     => ! [B] :
          ( m1_subset_1(B,k1_zfmisc_1(u1_struct_0(A)))
         => k2_tops_1(A,B) = k4_subset_1(u1_struct_0(A),k9_subset_1(u1_struct_0(A),k2_pre_topc(A,k3_subset_1(u1_struct_0(A),B)),B),k7_subset_1(u1_struct_0(A),k2_pre_topc(A,B),B)) ) ) )).
