%------------------------------------------------------------------------------
% File     : MPT1544+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : yellow_0__t22_yellow_0---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   76 (  16 unit)
%            Number of atoms       :  302 (  30 equality)
%            Maximal formula depth :   17 (   5 average)
%            Number of connectives :  272 (  46   ~;   2   |; 141   &)
%                                         (  10 <=>;  73  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   45 (   0 propositional; 1-3 arity)
%            Number of functors    :   15 (   1 constant; 0-3 arity)
%            Number of variables   :  134 (   0 sgn; 103   !;  31   ?)
