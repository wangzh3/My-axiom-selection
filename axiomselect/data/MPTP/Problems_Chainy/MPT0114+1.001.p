%------------------------------------------------------------------------------
% File     : MPT0114+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : xboole_1__t107_xboole_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   42 (  32 unit)
%            Number of atoms       :   60 (  31 equality)
%            Maximal formula depth :    8 (   4 average)
%            Number of connectives :   20 (   2   ~;   0   |;   9   &)
%                                         (   3 <=>;   6  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    3 (   0 propositional; 2-2 arity)
%            Number of functors    :    5 (   1 constant; 0-2 arity)
%            Number of variables   :   91 (   2 sgn;  91   !;   0   ?)
