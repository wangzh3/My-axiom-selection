%------------------------------------------------------------------------------
% File     : MPT0423+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : setfam_1__t55_setfam_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   99 (  33 unit)
%            Number of atoms       :  216 (  83 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :  166 (  49   ~;   5   |;  34   &)
%                                         (  27 <=>;  51  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    5 (   0 propositional; 2-2 arity)
%            Number of functors    :    9 (   1 constant; 0-2 arity)
%            Number of variables   :  234 (   1 sgn; 232   !;   2   ?)
