%------------------------------------------------------------------------------
% File     : MPT0182+1.004 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : enumset1__t99_enumset1---4.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :    7 (   6 unit)
%            Number of atoms       :   11 (  10 equality)
%            Maximal formula depth :   12 (   7 average)
%            Number of connectives :    8 (   4   ~;   0   |;   2   &)
%                                         (   2 <=>;   0  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    2 (   0 propositional; 2-2 arity)
%            Number of functors    :    6 (   0 constant; 3-8 arity)
