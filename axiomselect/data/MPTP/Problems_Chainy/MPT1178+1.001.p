%------------------------------------------------------------------------------
% File     : MPT1178+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : orders_2__t87_orders_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   24 (  10 unit)
%            Number of atoms       :   79 (   9 equality)
%            Maximal formula depth :   10 (   5 average)
%            Number of connectives :   74 (  19   ~;   1   |;  35   &)
%                                         (   2 <=>;  17  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   13 (   0 propositional; 1-3 arity)
%            Number of functors    :   11 (   1 constant; 0-2 arity)
%            Number of variables   :   54 (   0 sgn;  50   !;   4   ?)
