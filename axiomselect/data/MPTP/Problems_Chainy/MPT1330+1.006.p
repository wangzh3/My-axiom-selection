%------------------------------------------------------------------------------
% File     : MPT1330+1.006 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tops_2__t52_tops_2---6.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   43 (  13 unit)
%            Number of atoms       :  109 (  32 equality)
%            Maximal formula depth :    9 (   5 average)
%            Number of connectives :   72 (   6   ~;   1   |;  26   &)
%                                         (   7 <=>;  32  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   15 (   0 propositional; 1-3 arity)
%            Number of functors    :   25 (   1 constant; 0-8 arity)
%            Number of variables   :   94 (   0 sgn;  92   !;   2   ?)
