%------------------------------------------------------------------------------
% File     : MPT0255+1.005 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t50_zfmisc_1---5.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   24 (  22 unit)
%            Number of atoms       :   26 (  26 equality)
...
%            Number of variables   :   78 (   2 sgn;  78   !;   0   ?)
