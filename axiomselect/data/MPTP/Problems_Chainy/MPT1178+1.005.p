%------------------------------------------------------------------------------
% File     : MPT1178+1.005 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : orders_2__t87_orders_2---5.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   20 (  14 unit)
%            Number of atoms       :   53 (  21 equality)
%            Maximal formula depth :    9 (   5 average)
%            Number of connectives :   45 (  12   ~;   0   |;  22   &)
%                                         (   3 <=>;   8  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    9 (   0 propositional; 1-3 arity)
%            Number of functors    :   22 (   2 constant; 0-8 arity)
