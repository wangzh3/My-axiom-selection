%------------------------------------------------------------------------------
% File     : MPT0346+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : subset_1__t16_subset_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   35 (  11 unit)
%            Number of atoms       :   86 (  28 equality)
%            Maximal formula depth :   13 (   5 average)
%            Number of connectives :   67 (  16   ~;   2   |;  13   &)
%                                         (  19 <=>;  17  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    6 (   0 propositional; 1-2 arity)
%            Number of functors    :    8 (   1 constant; 0-3 arity)
%            Number of variables   :   85 (   0 sgn;  83   !;   2   ?)
