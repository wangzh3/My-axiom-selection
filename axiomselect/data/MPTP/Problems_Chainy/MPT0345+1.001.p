%------------------------------------------------------------------------------
% File     : MPT0345+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : subset_1__t15_subset_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   70 (  34 unit)
%            Number of atoms       :  153 (  65 equality)
%            Maximal formula depth :   13 (   5 average)
%            Number of connectives :  124 (  41   ~;   4   |;  35   &)
%                                         (  24 <=>;  20  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    6 (   0 propositional; 1-2 arity)
%            Number of functors    :   11 (   1 constant; 0-3 arity)
%            Number of variables   :  178 (   2 sgn; 175   !;   3   ?)
