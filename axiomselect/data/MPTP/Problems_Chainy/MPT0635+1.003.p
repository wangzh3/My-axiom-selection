%------------------------------------------------------------------------------
% File     : MPT0635+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_1__t38_funct_1---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   22 (  13 unit)
%            Number of atoms       :   38 (  18 equality)
%            Maximal formula depth :    9 (   5 average)
%            Number of connectives :   16 (   0   ~;   0   |;   6   &)
%                                         (   2 <=>;   8  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    5 (   0 propositional; 1-2 arity)
%            Number of functors    :   18 (   0 constant; 1-8 arity)
