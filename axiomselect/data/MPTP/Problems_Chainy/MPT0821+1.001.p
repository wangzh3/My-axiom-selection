%------------------------------------------------------------------------------
% File     : MPT0821+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : relset_1__t22_relset_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   68 (  13 unit)
%            Number of atoms       :  180 (  37 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :  150 (  38   ~;   2   |;  39   &)
%                                         (  26 <=>;  45  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   11 (   0 propositional; 1-2 arity)
%            Number of functors    :   17 (   1 constant; 0-3 arity)
%            Number of variables   :  170 (   0 sgn; 165   !;   5   ?)
