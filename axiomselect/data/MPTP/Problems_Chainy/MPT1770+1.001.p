%------------------------------------------------------------------------------
% File     : MPT1770+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t81_tmap_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :  159 (  16 unit)
%            Number of atoms       :  779 (  60 equality)
%            Maximal formula depth :   18 (   7 average)
%            Number of connectives :  720 ( 100   ~;   2   |; 316   &)
%                                         (  17 <=>; 285  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   25 (   0 propositional; 1-4 arity)
%            Number of functors    :   32 (   1 constant; 0-6 arity)
%            Number of variables   :  429 (   1 sgn; 401   !;  28   ?)
