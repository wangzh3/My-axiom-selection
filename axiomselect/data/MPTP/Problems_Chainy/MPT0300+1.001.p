%------------------------------------------------------------------------------
% File     : MPT0300+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t108_zfmisc_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   22 (   4 unit)
%            Number of atoms       :   55 (  18 equality)
%            Maximal formula depth :   11 (   6 average)
%            Number of connectives :   49 (  16   ~;   2   |;  14   &)
%                                         (  11 <=>;   6  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    5 (   0 propositional; 1-2 arity)
%            Number of functors    :    7 (   1 constant; 0-2 arity)
%            Number of variables   :   59 (   1 sgn;  57   !;   2   ?)
