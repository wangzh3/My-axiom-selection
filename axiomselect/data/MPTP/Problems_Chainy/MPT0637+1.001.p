%------------------------------------------------------------------------------
% File     : MPT0637+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_1__t43_funct_1---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   35 (  25 unit)
%            Number of atoms       :   50 (  34 equality)
%            Maximal formula depth :    8 (   4 average)
%            Number of connectives :   15 (   0   ~;   1   |;   3   &)
%                                         (   5 <=>;   6  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    7 (   0 propositional; 1-2 arity)
%            Number of functors    :   11 (   1 constant; 0-2 arity)
%            Number of variables   :   77 (   2 sgn;  77   !;   0   ?)
