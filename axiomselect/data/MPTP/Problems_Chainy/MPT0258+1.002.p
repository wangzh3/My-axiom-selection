%------------------------------------------------------------------------------
% File     : MPT0258+1.002 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t53_zfmisc_1---2.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   20 (  17 unit)
%            Number of atoms       :   25 (  19 equality)
...
%            Number of variables   :   68 (   2 sgn;  68   !;   0   ?)
