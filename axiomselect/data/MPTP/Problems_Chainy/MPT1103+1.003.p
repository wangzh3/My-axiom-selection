%------------------------------------------------------------------------------
% File     : MPT1103+1.003 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : pre_topc__t23_pre_topc---3.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   24 (  17 unit)
%            Number of atoms       :   37 (  24 equality)
%            Maximal formula depth :    9 (   4 average)
%            Number of connectives :   17 (   4   ~;   0   |;   4   &)
%                                         (   0 <=>;   9  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :    4 (   0 propositional; 1-2 arity)
%            Number of functors    :   22 (   1 constant; 0-8 arity)
