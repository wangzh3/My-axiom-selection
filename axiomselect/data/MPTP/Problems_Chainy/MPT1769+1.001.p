%------------------------------------------------------------------------------
% File     : MPT1769+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : tmap_1__t80_tmap_1---1.p [MPTPTP]
...
%            Number of connectives :   71 (  12   ~;   0   |;  34   &)
%                                         (   2 <=>;  23  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   12 (   0 propositional; 1-6 arity)
