%------------------------------------------------------------------------------
% File     : MPT0271+1.005 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : zfmisc_1__t68_zfmisc_1---5.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   23 (  20 unit)
%            Number of atoms       :   26 (  23 equality)
...
%            Number of variables   :   71 (   2 sgn;  71   !;   0   ?)
