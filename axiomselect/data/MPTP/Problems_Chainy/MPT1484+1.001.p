%------------------------------------------------------------------------------
% File     : MPT1484+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : lattice3__t17_lattice3---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   45 (   4 unit)
%            Number of atoms       :  205 (  21 equality)
%            Maximal formula depth :   16 (   7 average)
%            Number of connectives :  174 (  14   ~;   3   |;  72   &)
%                                         (   8 <=>;  77  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   19 (   0 propositional; 1-3 arity)
%            Number of functors    :    8 (   1 constant; 0-3 arity)
%            Number of variables   :  113 (   0 sgn; 108   !;   5   ?)
