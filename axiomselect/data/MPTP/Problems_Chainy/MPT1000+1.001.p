%------------------------------------------------------------------------------
% File     : MPT1000+1.001 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : funct_2__t48_funct_2---1.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   21 (   5 unit)
%            Number of atoms       :   60 (  37 equality)
%            Maximal formula depth :   11 (   5 average)
%            Number of connectives :   47 (   8   ~;   2   |;  11   &)
%                                         (   5 <=>;  21  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
