%------------------------------------------------------------------------------
% File     : MPT1611+1.004 : TPTP v7.4.0. Released v7.4.0.
% Domain   : Set theory
% Problem  :
...
% Source   : [MPTP]
% Names    : yellow_1__t19_yellow_1---4.p [MPTPTP]

% Status   : Theorem
% Rating   : ? v7.4.0
% Syntax   : Number of formulae    :   26 (  18 unit)
%            Number of atoms       :   44 (  31 equality)
%            Maximal formula depth :    9 (   3 average)
%            Number of connectives :   24 (   6   ~;   1   |;   7   &)
%                                         (   4 <=>;   6  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
