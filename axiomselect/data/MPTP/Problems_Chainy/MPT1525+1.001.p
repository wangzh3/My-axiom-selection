...
%            Number of atoms       :  126 (  21 equality)
%            Maximal formula depth :   17 (   6 average)
%            Number of connectives :  105 (  10   ~;   1   |;  31   &)
%                                         (   9 <=>;  54  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
%            Number of predicates  :   29 (   0 propositional; 1-3 arity)
...
fof(fc8_orders_2,axiom,(
    ! [A,B] :
      ( ( v4_relat_2(B)
        & v1_partfun1(B,A)
        & m1_subset_1(B,k1_zfmisc_1(k2_zfmisc_1(A,A))) )
     => ( v1_orders_2(g1_orders_2(A,B))
        & v5_orders_2(g1_orders_2(A,B)) ) ) )).
